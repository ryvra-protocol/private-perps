...
- Under-margined intents are deterministically rejected at `MARGIN_INSUFFICIENT` before execution/state persistence, and include a proof-aware liquidation decision.
